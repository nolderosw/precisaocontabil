       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            markers:[
            {
            address: "Rua Raimundo Alves Silva, 21, Campina Grande, Paraíba, Brasil",  /* You can change your address from here */
            html: "<b>Endereço</b>: <br> Rua Raimundo Alves Silva, 21, Campina Grande, Paraíba, Brasil.",   /* You can change display address text from here */
            popup: true
            }
            ]
            });
